...
def get_leftover_of_bills(amount, denomination):
    ...
    """
    rem=amount-(amount//denomination)*denomination
    return rem
...
def exchangeable_value(budget, exchange_rate, spread, denomination):
    ...
    # Calculate the total potential value in the new currency
    total_new_currency = budget / actual_rate
    
    # Round down to the nearest full denomination unit
